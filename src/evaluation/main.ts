...
import { MonteCarloModel } from "./model.js";
import { MonteCarloView } from "./view.js";
import { MonteCarloController } from "./controller.js";

function main() {
  const model = new MonteCarloModel();  // Se instancia vacía
  const view = new MonteCarloView();
  const controller = new MonteCarloController(view, model);
}
